      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-invert max-w-none mb-12">
            <TypingIn>
              <h2 className="text-lg md:text-3xl font-bold mb-6">Streamlining Farm-to-Table Operations</h2>
            </TypingIn>
            <FadeInSubtle>
          ...
          <div className="prose prose-invert max-w-none mb-12 break-all">
            <TypingIn>
              <h2 className="text-lg md:text-3xl font-bold mb-6">Data-Powered Food Insights</h2>
            </TypingIn>
            <FadeInSubtle>
              <p className="text-lg text-muted-foreground mb-6">
                Orpheus enables food manufacturers, food service organizations, and farmers to control their operations and capture significantly more value than before. 
                By sourcing and encrypting disparate data and building intelligent oversight models that elevate understanding and mapping of alternative business decisions, Orpheus’ AI platform is transforming food and agricultural businesses for the new era of technology.
              </p>
            </FadeInSubtle>
          </div>
          ...
          <div className="prose prose-invert max-w-none mb-12">
            <TypingIn>
              <h2 className="text-lg md:text-3xl font-bold mb-6">Traceability and Predictive Foresight</h2>
            </TypingIn>
            <FadeInSubtle>
              <p className="text-lg text-muted-foreground mb-6">
                Orpheus’ traceability of supply chains is to help farmers and enterprising agriculture companies to leverage their data to run multiple scenario analyses to track business opportunities and develop the foresight to prevent weak yield cycles, agricultural attacks or unforeseen price fluctuations in food prices at the pace necessary to profit in the twenty first century.
              </p>
            </FadeInSubtle>
          </div>
